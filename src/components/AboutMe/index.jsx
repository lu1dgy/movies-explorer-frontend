        ...
        <div className={style.about__portfolio}>
          <div className={style.about__information}>
            ...
            <p className={style.about__text}>
              Я родился и вырос в Самаре, и с самого детства увлекаюсь технологиями. В мире
              веб-разработки я чувствую себя как рыба в воде, и мой стек технологий включает
              ReactJS, TypeScript, Redux, Express и MongoDB.
            </p>
            <a
          ...
          <img className={style.about__avatar} src={avatar} alt='avatar' />
        </div>
      </div>
    </section>
  );
